 ...
 */
 ...
 const getWeatherData = async () => {
   ...
   try {
     ...
     const city = searchInput.value || 'Cuttack'
 ...
 const updateDom = data => {
   ...
   // Current temperature
   currentTemperature.innerText = Math.round((data[0].main.temp.toFixed(1)-32)*0.556)
   ...
   lowestToday.innerText = Math.round((data[0].main.temp_min-32)*0.556)
 
   // Highest Temperature of the Day
   highestToday.innerText = Math.round((data[0].main.temp_max-32)*0.556)
